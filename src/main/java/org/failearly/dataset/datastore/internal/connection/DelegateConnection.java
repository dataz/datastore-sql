...
/**
 * DelegateConnection delegates to {@link Connection}.
 */
public class DelegateConnection implements Connection {
    ...
    @Override
    public int hashCode() {
        return getInnerMostConnection().hashCode();
    }

    @Override
    public boolean equals(Object obj) {
        return obj instanceof Connection && getInnerMostConnection().equals(obj);
    }
    ...
    Connection getInnerMostConnection() {
        if( this.connection instanceof DelegateConnection )
            return ((DelegateConnection) this.connection).getInnerMostConnection();
